<?php 
	...
	//takes 2 arguments, currently subject and page or null
	...
	function generate_salt($length){
		//Not 100% unique, not 100% random, but good enough returns 32 chars
		$unique_random_string = md5(uniqid(mt_rand(), true));

		//valid chars for a salt [a-zA-z0-9./]
		$base64_string = base64_encode($unique_random_string);

		//not + which is valid in base64 encoding
	...
	function password_check($password, $existing_hash){
		//existing hash contains format and salt at beginnig
